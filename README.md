...
### Processo de Ideação
O processo de ideação deste projeto partiu da necessidade de profissionalizar a presença digital da gelateria. Entendemos que, para uma empreendedora autônoma, o site não deve ser apenas informativo, mas uma ferramenta de conversão e fidelização.
